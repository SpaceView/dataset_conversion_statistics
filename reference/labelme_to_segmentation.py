...
dir_img = 'E:/ESight/GoldLineRnTest/'
dir_ann = 'E:/ESight/GoldLineRnTest/coco'
dir_target = 'E:/ESight/GoldLineRnTest/rotated'
...
def main():
    ...
    parser.add_argument("--input_dir", default= dir_img, help="input image directory")
    parser.add_argument("--input_ann", default= dir_ann, help="input annotation directory")
